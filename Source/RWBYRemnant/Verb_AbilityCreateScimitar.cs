...
{
    class Verb_AbilityCreateScimitar : Verb_UseAbilitySemblanceBase
    {
        protected override bool TryCastShot()
        {
            ...
            else
            {
                ...
                {
                    ThingWithComps createdWeapon = (ThingWithComps)ThingMaker.MakeThing(RWBYDefOf.RWBY_Cinder_Scimitar);
