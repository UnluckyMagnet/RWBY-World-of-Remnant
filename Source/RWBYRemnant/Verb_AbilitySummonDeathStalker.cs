...
{
    class Verb_AbilitySummonDeathStalker : Verb_UseAbilitySemblanceBase
    {
        protected override bool TryCastShot()
        {
            ...
            else
            {
                for (int i = 0; i < this.TargetsAoE.Count; i++)
                {
                    ...
                    glyph.TryGetComp<CompGlyphSummon>().SetData(GenTicks.SecondsToTicks(1.5f), RWBYDefOf.Grimm_DeathStalker_Summoned);
