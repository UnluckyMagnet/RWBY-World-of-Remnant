...
{
    class Verb_AbilityReturnDamage : Verb_UseAbilitySemblanceBase
    {
        protected override bool TryCastShot()
        {
            ...
            else
            {
                for (int i = 0; i < this.TargetsAoE.Count; i++)
                {
                    ...
                    returnDamageHediff = HediffMaker.MakeHediff(RWBYDefOf.RWBY_YangReturnDamage, CasterPawn);
                    CasterPawn.health.AddHediff(returnDamageHediff);
