    ...
    public class JobDriverStealAura : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            stealAura.initAction = delegate ()
            {
                ...
                {
                    if (targetPawn.TryGetComp<CompAbilityUserAura>() != null && glove.TryGetComp<Weapon_StealAuraAbility>() != null)
                    {
                        ...
                        glove.TryGetComp<Weapon_StealAuraAbility>().stolenTraitDef = targetPawn.story.traits.allTraits.FindAll(t => t.def == RWBYDefOf.RWBY_Aura || SemblanceUtility.semblanceList.Contains(t.def)).RandomElement().def;
